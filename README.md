...
|--------------------|-----|---------------------------------------------------------|
| phone_code         | str | Код страны, например 7                                  |
| phone              | str | Номер телефона без + и кода страны, например 9123456789 |
| number_of_cycles   | int | Количество повторений                                   |
...
response = requests.post("http://127.0.0.1:8080/attack/start", data=params)
