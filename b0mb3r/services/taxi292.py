...
class Taxi292(Service):
    ...
    async def run(self):
        locations = [
            {"name": "Гуливер тц (Спортивная пл.1)", "lat": 50.4373112240241, "lng": 30.520967206634},
            {"name": "ЦИРК (пл.Победы2)", "lat": 50.447202162029, "lng": 30.492127674114},
            {"name": "Аэропорт Борисполь терминал F✈", "lat": 50.3428132658132, "lng": 30.8902956980719},
            {"name": "ШЕВЕЛЕВА ЮРИЯ УЛ.", "lat": 50.4248647934474, "lng": 30.6631460783441, "number": "48"}
        ]
        servers = [
